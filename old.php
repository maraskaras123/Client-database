...
<html>
    <head>
        <title>Sveiki atvykę į <? print $host; ?>! Hostinger web hostingas su PHP ir MySQL.</title>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.lt/"><img src="http://www.hostinger.lt/images/logo-lt.png" alt="Hostingas" /></a>
                </div>
                <div class="content">
                    <h1>Jūsų svetainė aktyvuota!</h1>
                    <p>Svetainė <b><? print $host; ?></b> ką tik buvo sėkmingai aktyvuota! Prašome ištrinti failą <b>default.php</b> iš katalogo <b>public_html</b> ir tada galėsite įkelti savo svetainės turinį naudodami FTP protokolą arba Failų Tvarkyklę.</p>
                    <p>Žemiau rasite public_html aplanke esančius failus:</p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://www.hostinger.lt/" target="_blank">Nemokamas Hostingas</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.lt/hostingas" target="_blank">Hostingas</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.lt/forum" target="_blank">Pagalbos Forumas</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.lt/" target="_blank">Nario Zona</a>
                </div>
                <div class="copyright">Hostinger Lietuva &copy; <? print date('Y'); ?>. Visos teisės saugomos.</div>
                <div class="social-icons">
                    <a href="http://www.facebook.com/Hostinger.lt"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
